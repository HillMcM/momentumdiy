  ...
  const withFallback = (goal: MarketingGoal, module: MarketingModule): MarketingModule => {
    ...
    if (title.includes('foot traffic') || title.includes('local foot traffic') || title.includes('increase local foot traffic') || title.includes('improving local foot traffic')) {
      ...
      switch (module.weekNumber) {
        ...
        case 11: {
          const content = buildContent(
            '**Hey There!** You\'ve been showing up, engaging your community, and creating a great experience. This week, we pause for just a moment to *listen*—because your customers often hold the clearest insights about how your marketing is landing.',
            'A quick check-in can spark fresh ideas, uncover hidden gaps, or reaffirm what\'s working. And when you ask the right way? It makes people feel *seen* and even more loyal to your brand.',
