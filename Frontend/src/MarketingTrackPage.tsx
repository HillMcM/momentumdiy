      ...
      switch (module.weekNumber) {
        ...
        case 9: {
          const content = buildContent(
            ...
            'This week, we\'re going to unlock one of your most powerful (and affordable) marketing tools:',
            '**the people who already love what you do.**'
          );
          const tasks = [
        ...
        case 10: {
          const content = [
            '**Hey There!**',
            '',
            'This week is about **borrowing trust**.',
            '',
            'There are people and businesses in your community who already have the attention of your ideal customers—so let\'s **team up** and get in front of that audience, naturally and meaningfully.',
            '',
            'You don\'t need a celebrity. You just need someone whose word carries weight *locally*.',
            '',
            '## Pro Tip',
            'The best collaborations feel like a natural fit, not a forced partnership. Look for businesses that serve the same people but solve different problems.',
            '',
            '## Identify Your Local Influencers & Beloved Businesses',
            '**List 3 potential collaborators whose followers align with your audience:**',
            '',
            '**1. Business/Influencer Name:** _________________',
            '**Industry/Focus:** _________________',
            '**Why They\'re a Good Fit:** _________________',
            '**Their Audience:** _________________',
            '',
            '**2. Business/Influencer Name:** _________________',
            '**Industry/Focus:** _________________',
            '**Why They\'re a Good Fit:** _________________',
            '**Their Audience:** _________________',
            '',
            '**3. Business/Influencer Name:** _________________',
            '**Industry/Focus:** _________________',
            '**Why They\'re a Good Fit:** _________________',
            '**Their Audience:** _________________',
            '',
            '**What to Look For:**',
            '- Businesses with 1,000+ local followers',
            '- People who post about your neighborhood/community',
            '- Accounts that engage with local businesses',
            '- Influencers who share your values or aesthetic',
            '',
            '## Choose Your Collaboration Type',
            '**Select the type of collaboration you want to offer:**',
            '',
            '**📢 Social Shoutout Swap**',
            '> **What it is:** You both post about each other on the same day',
            '> **Example:** "Check out this amazing [business] in our neighborhood!"',
            '> **Best for:** Quick exposure and mutual support',
            '',
            '**🎁 Local Giveaway**',
            '> **What it is:** Co-host a giveaway featuring both businesses',
            '> **Example:** "Win a [your product] + [their product] bundle!"',
            '> **Best for:** Building excitement and new followers',
            '',
            '**📰 Feature or Interview**',
            '> **What it is:** They feature you in their content or vice versa',
            '> **Example:** "Behind the scenes at [your business]" or "Meet the owner"',
            '> **Best for:** Building deeper relationships and trust',
            '',
            '**🎨 Custom Collaboration**',
            '> **What it is:** Your own unique partnership idea',
            '> **Example:** _________________',
            '> **Best for:** Standing out and creating buzz',
            '',
            '## Guided Outreach Tool',
            '**Use this template to reach out to your chosen collaborator:**',
            '',
            '**Your Message:**',
            '_________________________________',
            '_________________________________',
            ...
            '> Hi [Name],',
            '> ',
            '> I\'m [Your Name] from [Your Business] in [Neighborhood]. I love what you\'re building and think our customers would really connect with your [product/service].',
            '> ',
            '> I\'d love to explore a simple collaboration that could bring new faces through both our doors. Maybe something like [your chosen collaboration type]?',
            '> ',
            '> Would you be open to a quick coffee or call to brainstorm?',
            '> ',
            '> Thanks for considering!',
            ...
            '',
            '**Outreach Tips:**',
            '- Keep it personal and specific to their business',
            '- Mention why you think it\'s a good fit',
            '- Propose a simple, low-commitment collaboration',
            '- Offer to meet in person or hop on a call',
            '',
            '## Plan Your Collaboration',
            '**Organize the details of your partnership:**',
            '',
            '**📅 Collaboration Timeline:**',
            '- [ ] Start Date: _________________',
            '- [ ] End Date: _________________',
            '- [ ] Duration: _________________ (e.g., 1 week, 1 month)',
            '',
            ...
            '- [ ] _________________',
            '',
            '**What Your Collaborator is Responsible For:**',
            '- [ ] _________________',
            '- [ ] _________________',
            '- [ ] _________________',
            '',
            '**📋 Collaboration Rules:**',
            '- [ ] How often you\'ll post about each other',
            '- [ ] What hashtags or mentions to use',
            '- [ ] How to handle any giveaways or promotions',
            '- [ ] Communication schedule and check-ins',
            '',
            '## Track Your Collaboration Results',
            '**Monitor the impact of your partnership:**',
            '',
            '**📊 New Walk-ins from Collaboration:**',
            '- [ ] Week 1: ___ new customers',
            '- [ ] Week 2: ___ new customers',
            '- [ ] Week 3: ___ new customers',
            '- [ ] Week 4: ___ new customers',
            '',
            '**📈 Additional Metrics to Track:**',
            '- [ ] New social media followers',
            '- [ ] Social media engagement increase',
            '- [ ] Customers mentioning the collaboration',
            '- [ ] Sales from collaboration referrals',
            '- [ ] Brand awareness boost',
            '',
            '**🎯 Success Indicators:**',
            '- [ ] Reached target number of new walk-ins',
            '- [ ] Built lasting relationship with collaborator',
            '- [ ] Generated positive social media buzz',
