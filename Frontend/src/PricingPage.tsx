        ...
        <div className="mx-auto max-w-7xl px-6 pb-16 lg:px-8">
          ...
          <section className="mx-auto mt-16 max-w-5xl overflow-hidden rounded-2xl border border-slate-800 bg-gradient-to-r from-emerald-400/10 via-emerald-400/5 to-transparent p-8 text-center ring-1 ring-emerald-300/10">
            ...
            <div className="mt-5 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <button onClick={() => navigate('/checkout/momentumdiy/yearly')} className="inline-flex items-center justify-center rounded-xl bg-emerald-400 px-5 py-3 font-semibold text-slate-900 transition hover:bg-emerald-300 focus:outline-none focus:ring-2 focus:ring-emerald-300">
                Start Free Trial
              </button>
              <button onClick={() => navigate('/')} className="inline-flex items-center justify-center rounded-xl bg-white/10 px-5 py-3 font-semibold text-white transition hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/40">
