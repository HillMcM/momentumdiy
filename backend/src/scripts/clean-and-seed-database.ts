...
// This script completely cleans and reseeds the marketing track database
async function cleanAndSeedDatabase() {
  try {
    console.log('🧹 Cleaning and reseeding marketing track database...');

    // Step 1: Delete all existing marketing data
    ...
    // Step 2: Create the clean marketing goal
    ...
    // Step 3: Create modules for weeks 1-4 with correct content
