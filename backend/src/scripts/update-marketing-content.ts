...
// This script updates the marketing track content in Supabase with the correct 12-week content
async function updateMarketingContent() {
  try {
    ...
    // Update the goal with correct description
    ...
    // Now let's update the modules with the correct content
    const moduleUpdates = [
      {
        id: 'week-1',
