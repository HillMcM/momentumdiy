...
// This script restores all the complete tasks for all 12 weeks from the backup branch
async function restoreCompleteTasks() {
  try {
    console.log('🔄 Restoring complete tasks for all 12 weeks from backup branch...');

    // Get the active goal and all modules
    ...
    // Define all tasks for all 12 weeks from the backup branch
    const allTasks = [
      // Week 1 tasks
      {
