...
/**
 * Add tasks to Social Media track modules
 */
async function addSocialMediaTasks() {
  try {
    ...
    // Get all module definitions for this track
    ...
    for (const module of modules) {
      const tasks = weeklyTasks[module.week_number as keyof typeof weeklyTasks];
      if (!tasks) {
