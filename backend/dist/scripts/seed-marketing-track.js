...
exports.seedMarketingTrack = seedMarketingTrack;
...
async function seedMarketingTrack() {
    try {
        console.log('🌱 Starting marketing track seeding...');
        const { error: goalError } = await supabase_1.supabase
...
//# sourceMappingURL=seed-marketing-track.js.map