...
${this.getPersonalizedRecommendations(industry || 'Not specified', experienceLevel || 'Not specified', context.pagePath || '/app')}`;
    ...
    static getLocationInsights(pagePath) {
    ...
    static getPersonalizedRecommendations(industry, experienceLevel, pagePath) {
    ...
    static getIndustrySpecificGuidance(industry, businessType, experienceLevel) {
        const guidance = {
...
- Experience Level: ${experienceGuidance[experienceLevel] || experienceGuidance['Not specified']}`;
    ...
    static getWeekSpecificGuidance(week, _activeGoal) {
        const weekGuidance = {
    ...
    static getPageSpecificGuidance(pagePath) {
        const pageGuidance = {
    ...
    static getMarketingKnowledgeBase(context) {
...
- **Why**: Direct line to customers who already know you`;
    ...
    static getIndustryStrategy(industry) {
        const strategies = {
