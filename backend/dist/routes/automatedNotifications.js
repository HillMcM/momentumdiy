...
router.post('/run-all', (0, rate_1.routeRateLimit)(5), async (_req, res) => {
    try {
        logger_1.logger.info('Manual trigger of all automated notifications');
...
router.post('/weekly-progress', (0, rate_1.routeRateLimit)(10), async (_req, res) => {
    try {
        logger_1.logger.info('Manual trigger of weekly progress reports');
        ...
        logger_1.logger.error('Error sending weekly progress reports', error);
        return res.status(500).json({
            success: false,
...
router.post('/trial-ending', (0, rate_1.routeRateLimit)(10), async (_req, res) => {
    try {
        logger_1.logger.info('Manual trigger of trial ending notifications');
        ...
        logger_1.logger.error('Error sending trial ending notifications', error);
        return res.status(500).json({
            success: false,
...
router.post('/task-reminders', (0, rate_1.routeRateLimit)(10), async (_req, res) => {
    try {
        logger_1.logger.info('Manual trigger of task reminder notifications');
        ...
        logger_1.logger.error('Error sending task reminder notifications', error);
        return res.status(500).json({
            success: false,
...
router.post('/schedule', (0, rate_1.routeRateLimit)(5), async (_req, res) => {
    try {
        logger_1.logger.info('Checking scheduled notifications');
        ...
        logger_1.logger.error('Error running scheduled notifications', error);
        return res.status(500).json({
            success: false,
